...
if posicionHorizontal>=0 and posicionHorizontal<=7 and posicionVertical>=0 and posicionVertical<=7:
    ...
    print ("El valor asignado a la posicon HORIZONTAL  no esta dentro del rango aceptable(de 0 a 8), vuelve a empezar")
else:
    print ("El valor asignado a la posicon VERTICAL  no esta dentro del rango aceptable(de 0 a 8), vuelve a empezar") 
